...
import com.dev.dna.expensetracker.feature.add_expense.ExpenseDropDown
import com.dev.dna.expensetracker.feature.home.HomeViewModel
import com.dev.dna.expensetracker.feature.home.TransactionItem
            ...
            LazyColumn(
                ...
                items(filteredByDateRange) { item ->
                    ...
                    TransactionItem(
                        ...
                        Modifier.animateItem(tween(100))
                    )
                }
            }
        }
